...
source ~/qmk/qmk_firmware/util/qmk_tab_complete.sh

function cpBuilt(){
    rsync -av --include='*.uf2' --include='*.hex' --exclude='*' ~/qmk/qmk_firmware/.build/ ~/MyKeyBoards/build/
}
# --------------------------------------------------
# --------------------------------------------------
