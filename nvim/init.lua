...
---- ff
--      -- file (default)
--      keymap("n", "<Space>uf", [[<Cmd>call ddu#start({})<CR>]], opts)
--      -- buffer
--      keymap("n", "<Space>ub", "<Cmd>call ddu#start({'name': 'buffer'})<CR>", opts)
--      --keymap("n", "<Space>ub", "<Cmd>call ddu#start({" ..
--      --"'sources': [{'name': 'buffer'}], " ..
--      --"})<CR>", opts)
--      -- grep
--      keymap("n", "<Space>ug", "<Cmd>call ddu#start({" ..
--      "'name': 'grep', " ..
...
--      "})<CR>", opts)
--      -- help-ff
--      keymap("n", "<Space>uh", "<Cmd>call ddu#start({" ..
--      "'name': 'help-ff', " ..
--      "})<CR>", opts)
...
--
---- filer
--      keymap("n", "<Space>ue", "<Cmd>call ddu#start({" ..
--        "'name':'filer'," ..
--        "'searchPath':expand('%:p')" ..
--      "})<CR>", opts)
--
...
--		config = function()
--			keymap("n", "<Space><Space>", "<Plug>(easymotion-prefix)", opts)
--			--vim.g["EasyMotion_do_mapping"] = 0
--			keymap("n", "S", "<Plug>(easymotion-overwin-f2)", opts)
